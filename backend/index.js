...
// Endpoint to fetch restaurants data
...
// Endpoint to fetch restaurant menu
...
// Test route
app.get('/', (req, res) => {
  res.json({ "message": "Hello, I'm an intermediary API proxy between your frontend and the Swiggy API" });
});
